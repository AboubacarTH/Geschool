...
public class MessageForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(rSMTextFull_recherche, javax.swing.GroupLayout.DEFAULT_SIZE, 396, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jTable_eleve.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "N°", "CLASSE", "MATRICULE", "NOM ET PRENOM", "TEL. PARENT/TUTEUR"
            }
        ) {
        ...
        if (jTable_eleve.getColumnModel().getColumnCount() > 0) {
            ...
            jTable_eleve.getColumnModel().getColumn(2).setMinWidth(80);
            jTable_eleve.getColumnModel().getColumn(2).setPreferredWidth(80);
            jTable_eleve.getColumnModel().getColumn(2).setMaxWidth(80);
            jTable_eleve.getColumnModel().getColumn(4).setMinWidth(200);
            jTable_eleve.getColumnModel().getColumn(4).setPreferredWidth(200);
            jTable_eleve.getColumnModel().getColumn(4).setMaxWidth(200);
        }
    ...
    private void menu_item_add_contactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menu_item_add_contactActionPerformed
        ...
        Eleve eleve = eleveController.getEleve(jTable_eleve.getValueAt(row, 2).toString());
    ...
    private void menu_item_add_allActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menu_item_add_allActionPerformed
        if(rSComboMetro_classe.getSelectedIndex() < 0 || rSComboMetro_annee.getSelectedIndex() < 0){
            return;
        }
        eleveController.getListEleve(rSComboMetro_annee.getSelectedItem().toString(), null, rSComboMetro_classe.getSelectedItem().toString(), null, null, null).forEach((e) -> {
    ...
    private void initTable(){
        String entete[] = {"N°", "CLASSE", "MATRICULE", "NOM ET PRENOM", "TEL. PARENT/TUTEUR"};
        ...
        if(!"Toutes".equals(rSComboMetro_annee.getSelectedItem().toString())){
            ArrayList<Eleve> l = new ArrayList<>();
            for (Eleve e : list_eleve) {
                if(e.getClasse().getAnnee().equals(rSComboMetro_annee.getSelectedItem().toString())){
                    l.add(e);
                }
            }
            list_eleve = l;
        ...
        if(!"Toutes".equals(rSComboMetro_classe.getSelectedItem().toString())){
            ArrayList<Eleve> l = new ArrayList<>();
            for (Eleve e : list_eleve) {
                if(e.getClasse().getClasse().equals(rSComboMetro_classe.getSelectedItem().toString())){
                    l.add(e);
                }
            }
            list_eleve = l;
        ...
        if(rSMTextFull_recherche.getText().length() > 0){
            ArrayList<Eleve> l = new ArrayList<>();
            for (Eleve e : list_eleve) {
                if(e.getMatricule().contains(rSMTextFull_recherche.getText()) || e.getNom_prenom().contains(rSMTextFull_recherche.getText())){
                    l.add(e);
                }
            }
            list_eleve = l;
        ...
        for(int i = 0; i< list_eleve.size(); i++){
            ...
            colonne[4] = list_eleve.get(i).getContact();
            dt.addRow(colonne);
        }
