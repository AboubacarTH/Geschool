...
public class AnneeDialog extends javax.swing.JDialog {
    ...
    public AnneeDialog(java.awt.Frame parent, boolean modal, String oldValue) {
        super(parent, modal);
        this.oldValue = oldValue;
        anneeScolaireController = new AnneeScolaireController();
        initComponents();
        txt_annee.setText(oldValue);
    }
    ...
    private void btn_validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_validerActionPerformed
        if(txt_annee.getText().length() <= 0 || !txt_annee.getText().contains("-")){
            JOptionPane.showMessageDialog(this, "Champ vide ou ne contenant pas '-' ", "Erreur de syntaxe !", JOptionPane.WARNING_MESSAGE);
        }else{
            if(oldValue == null){
                anneeScolaireController.addAnneeScolaire(new bean.AnneeScolaire(txt_annee.getText()));
            }else{
                anneeScolaireController.setAnneeScolaire(new bean.AnneeScolaire(oldValue), new bean.AnneeScolaire(txt_annee.getText()));
            }
            success_information();
            this.dispose();
        }
